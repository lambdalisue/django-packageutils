...
"""
Automatically create admin in Django syncdb command
...
if settings.AUTO_CREATE_USER:
    ...
    def create_testuser(app, created_models, verbosity, **kwargs):
        ...
        PASSWORD = getattr(settings, 'AUTO_CREATE_PASSWORD', 'admin')
        EMAIL = getattr(settings, 'AUTO_CREATE_EMAIL', 'x@x.com')

        if getattr(settings, 'AUTO_CREATE_USER_MODEL', None):
            User = models.get_model(*settings.AUTO_CREATE_USER_MODEL.rsplit('.', 1))
        else:
